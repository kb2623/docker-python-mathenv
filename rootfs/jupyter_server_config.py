...
#  Default: ''
c.ServerApp.certfile = u'##USER_HOME##/.jupyter/##SSL_KEY_NAME##.pem'
...
#  Default: ''
c.ServerApp.keyfile = u'##USER_HOME##/.jupyter/##SSL_KEY_NAME##.key'
...
#  Default: ''
c.ServerApp.password = '##NB_PASSWORD##'
...
#  Choices: any of ['sha256', 'md5', 'sha384', 'blake2s', 'sha224', 'sha3_384', 'sha3_512', 'sha1', 'sha512', 'blake2b', 'sha3_256', 'sha3_224']
#  Default: 'sha256'
